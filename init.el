...
(custom-set-variables
 ...
 '(ignored-local-variable-values
   '((flycheck-clang-language-standard . "c11")
     ...
     (gud-gdb-command-name . "C:\\remedybg.exe rift.rdbg")))
 '(menu-bar-mode nil)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(font-lock-type-face ((t (:foreground "light slate gray" :family "JetBrainsMonoNL NFM"))))
 '(isearch ((t (:background "gray" :foreground "black"))))
 '(markdown-code-face ((t nil)))
 '(persp-selected-face ((t (:foreground "misty rose" :weight bold)))))
